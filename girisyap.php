...
<div class="page normal-page">
     <div class="container">
							...
							<div class="wpb_wrapper">
								<div class="wpb_text_column wpb_content_element ">
									<div class="wpb_wrapper">										<div class="title-wrapper">
											<h3 class="widget-title" style="border-color: "><i class="fa fa-newspaper-o"></i> GİRİS YAP</h3>
											<div class="clear"></div>
										</div>
		...
		<header>
		<input type="submit" value="Tıkla, giris yap" style="margin-top: 15px">
		<br><br>
		</div>
	</form>
									<!-- POST BİTİŞ -->
								...
								<div class="wpb_wrapper">
									<div class="widget-1 first widget">
										...
										<div class="textwidget">
											...
											<a href="https://kola2.craft.tc/kayit/">
