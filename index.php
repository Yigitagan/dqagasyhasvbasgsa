        ...
        <div class="after-nav ">
        	<div class="container">
                <div class="ticker-title"><i class="fa fa-bullhorn"></i> &nbsp;DUYURULAR</div>
                              <ul id="webticker" >
							                                   <li id='item'>
                               	         <a href="https://kola2.craft.tc/haber/10/" class="ticker_cat" style="background-color: #e0043f !important" >Duyuru!</a>
										<a href="https://kola2.craft.tc/haber/10/">İndexden Değiştirebilirsiniz</a>
									</li>
							                                   <li id='item'>
                               	         <a href="https://kola2.craft.tc/haber/1/" class="ticker_cat" style="background-color: #e0043f !important" >Duyuru!</a>
										<a href="https://kola2.craft.tc/haber/1/">deneme123</a>
									</li>
							                              </ul>
							...
							<div class="wpb_wrapper">
								<div class="wpb_text_column wpb_content_element ">
									<div class="wpb_wrapper">										<div class="title-wrapper">
											<h3 class="widget-title" style="border-color: "><i class="fa fa-newspaper-o"></i> HABERLER</h3>
											<div class="clear"></div>
										</div>
												...
												<div class="blog-post">
													<div class="blog-twrapper">
														<div class="blog-image ">
															<a href='/index.php'>
																<img height="300px" alt="img"  src="http://i.hizliresim.com/2npOZL.png" />
															</a>
														</div>
														<div class="blog-content ">
															<h2>
																<a href='/index.php'> GBF123 Site</a>
															</h2>
															<div class="post-pinfo">
																<a href='/index.php'> Genel </a>
																<i>|</i>
																 Yazan:<a href='/index.php'> GBF123 </a>
																<i>|</i>
																<span class="date"> 20.01.2019</span>
															</div>
															<p><p>
Yeni Sitemize Hoşgeldiniz Ulaşım erenata78@gmail.com
<br>

</p>
</p>
															<a href='/index.php' class="button-small">Görüntüle</a>
														</div>
													</div>
													<div class="clear"></div>
												</div>
		...
		<header>
											<a href="/girisyap.php">
												<input id="submit" name="submit" class="button-large button-green" type="submit" style="width:100%;" value="Giris Yap" tabindex="7">
											</a>
		<br><br>
		</div>
											</form>
...
body{
      /*  background-attachment: fixed !important; */
	    background:url('http://mc.tc/backgroundlib/background(46).gif') no-repeat center center fixed;
